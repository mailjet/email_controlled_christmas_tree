...
### Setup
1. Create a [Mailjet](https://www.mailjet.com/signup) account
2. Find your Mailjet API Key and Secret Key [here](https://app.mailjet.com/account/setup)
3. Setup instance of [Parse API](http://dev.mailjet.com/guides/parse-api-guide/) by using following curl request.  It will return back to you the email address people will send to to update the LEDs and LED dot matrix on the christmas tree:
...
9. Start emailing to control the christmas tree!
